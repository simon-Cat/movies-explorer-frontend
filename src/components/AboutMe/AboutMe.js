    ...
    <section className='about-me-container'>
      ...
      <section className='about-me-container__content'>
        <div className='about-me-container__student-info'>
          ...
          <p className='about-me-container__my-post'>
            Веб-разработчик, 32 года
          </p>
          <p className='about-me-container__about-me'>
          ...
          <a
            href='https://github.com/simon-Cat'
            target='_blank'
            rel='noreferrer'
            className='about-me-container__github-link'
          >
            Github
          </a>
        </div>
