    ...
    <section className='about-project-container'>
      ...
      <section className='about-project-container__steps'>
        <article className='about-project-container__step'>
          <h3 className='about-project-container__subtitle'>Дипломный проект включал 5 этапов</h3>
          <p className='about-project-container__description'>Составление плана, работу над бэкендом, вёрстку, добавление функциональности и финальные доработки.</p>
        </article>
        <article className='about-project-container__step'>
          <h3 className='about-project-container__subtitle'>На выполнение диплома ушло 5 недель</h3>
          <p className='about-project-container__description'>У каждого этапа был мягкий и жёсткий дедлайн, которые нужно было соблюдать, чтобы успешно защититься.</p>
        </article>
      </section>
